...
//    
   ...
   content.revalidate();
    ...
    private void initComponents() {
        ...
        btn_5.add(btn_users, java.awt.BorderLayout.CENTER);
        ...
        btn_9.setLayout(new java.awt.BorderLayout());
        ...
        btn_reports3.setInheritsPopupMenu(true);
        btn_reports3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_reports3ActionPerformed(evt);
            }
        });
    ...
    private void btn_reports3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_reports3ActionPerformed
         ...
         ShowJPanel(new D_Usuarios());
    }//GEN-LAST:event_btn_reports3ActionPerformed
    ...
    public javax.swing.JPanel btn_10;
