...
public class Menu_Medico_v2 extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard
     */
    public Menu_Medico_v2() {
        initComponents();
        InitStyles();
        SetDate();
        InitContent();
...
//    
   ...
   content.revalidate();
    ...
    private void initComponents() {
        ...
        btn_5.add(btn_reports2, java.awt.BorderLayout.CENTER);
    ...
    //  FlatMaterialLighterIJTheme.setup();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Medico_v2().setVisible(true);
            }
        });
    }
